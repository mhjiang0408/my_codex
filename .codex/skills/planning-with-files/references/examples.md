...
All command snippets assume you are running from the repo root. If you are inside a subdirectory, resolve the repo root first and then use `$WORKSPACE_ROOT/.codex/task_plan.md`.
...
### Loop 2: Research
```bash
Read .codex/task_plan.md    # Refresh goals
WebSearch "morning exercise benefits"
Write notes.md              # Store findings
Edit .codex/task_plan.md    # Mark Phase 2 complete
```
...
Edit .codex/task_plan.md    # Mark Phase 3 complete
```

### Loop 4: Deliver
```bash
Read .codex/task_plan.md    # Verify complete
...
→ Read .codex/task_plan.md   # This brings goals back into attention!
